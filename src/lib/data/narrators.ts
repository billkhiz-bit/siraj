...
export const narrators: Narrator[] = [
  ...
  { id: "nafi", name: "Nafi' mawla Ibn Umar", nameArabic: "نافع مولى ابن عمر", generation: "tabi'i", hadithCount: 620, deathYear: 117, description: "Freedman of Hazrat Ibn Umar, key link in golden chain" },
  { id: "urwah", name: "Urwah ibn al-Zubayr", nameArabic: "عروة بن الزبير", generation: "tabi'i", hadithCount: 540, deathYear: 94, description: "Nephew of Hazrat Aisha, early historian" },
