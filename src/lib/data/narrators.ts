...
export const narrators: Narrator[] = [
  ...
  { id: "zubayr", name: "Al-Zubayr ibn al-Awwam", nameArabic: "الزبير بن العوام", generation: "companion", hadithCount: 38, deathYear: 36, description: "One of the ten promised Paradise", titles: ["Hawari Rasulillah (Disciple of the Messenger)"], biography: "The Prophet's ﷺ cousin and one of the first to accept Islam at age 15. He was one of the ten companions promised Paradise. Known for his bravery, he was the first to draw his sword for Islam when a false rumour spread that the Prophet ﷺ had been killed. He fought in every battle alongside the Prophet ﷺ.", notableEvents: ["First to draw a sword for Islam", "One of the ten promised Paradise", "Fought in every battle with the Prophet ﷺ", "Called 'Disciple of the Messenger'"] },
  { id: "talha", name: "Talha ibn Ubaydullah", nameArabic: "طلحة بن عبيد الله", generation: "companion", hadithCount: 38, deathYear: 36, description: "The Generous", titles: ["Talha al-Khayr (The Good)", "One of the Ten Promised Paradise"], biography: "One of the earliest converts and one of the ten companions promised Paradise. At Uhud, he shielded the Prophet ﷺ with his own body, taking over 70 wounds and losing the use of two fingers. Abu Bakr said: 'That day belonged to Talha.' He was known for extraordinary generosity, once giving away 700,000 dirhams in a single day.", notableEvents: ["Shielded the Prophet ﷺ at Uhud (70+ wounds)", "One of the ten promised Paradise", "Gave 700,000 dirhams in one day", "Early convert, tortured by Quraysh"] },
  ...
  { id: "nafi", name: "Nafi' mawla Ibn Umar", nameArabic: "نافع مولى ابن عمر", generation: "tabi'i", hadithCount: 620, deathYear: 117, description: "Freedman of Ibn Umar, key link in golden chain" },
  { id: "urwah", name: "Urwah ibn al-Zubayr", nameArabic: "عروة بن الزبير", generation: "tabi'i", hadithCount: 540, deathYear: 94, description: "Nephew of Aisha, early historian" },
