...
export const sacredSites: SacredSite[] = [
  {
    ...
    keyEvents: [
      ...
      "Burial place of the Prophet ﷺ, Hazrat Abu Bakr, and Hazrat Umar",
      "Green Dome built in 1279 CE, painted green in 1837",
    ],
    connectedJourneys: ["hijrah", "badr", "farewell"],
    modelType: "structure",
    annotations: [
      { position: [2, 2.3, 0.5], label: "Green Dome", detail: "Built in 1279 CE over the burial chamber of the Prophet ﷺ, Hazrat Abu Bakr, and Hazrat Umar. Painted green in 1837." },
  ...
  },
  {
    ...
    history: "The Prophet ﷺ said: 'Uhud is a mountain that loves us and we love it.' The Battle of Uhud (625 CE / 3 AH) was fought at its base when 3,000 Quraysh attacked 700 Muslims. The Muslims initially prevailed, but archers left their posts on the hill, allowing Hazrat Khalid ibn al-Walid's cavalry to flank them. Hazrat Hamzah, the Prophet's ﷺ uncle, was martyred here. The Prophet ﷺ himself was wounded — his helmet rings pierced his cheek and he lost a tooth. The martyrs of Uhud, including Hamzah, are buried at its base.",
    quranicReferences: [
    ...
    keyEvents: [
      ...
      "Hazrat Hamzah ibn Abd al-Muttalib martyred",
    ...
    annotations: [
      ...
      { position: [1.5, 1, -7], label: "Archers' Hill", detail: "50 archers were posted here by the Prophet ﷺ with orders not to leave. When they left to collect spoils, Hazrat Khalid ibn al-Walid's cavalry flanked the Muslims." },
      { position: [-2.5, 0.5, -2.5], label: "Martyrs' Cemetery", detail: "70 martyrs are buried here including Hazrat Hamzah ibn Abd al-Muttalib, the 'Lion of Allah' and uncle of the Prophet ﷺ." },
    ],
  },
  {
    id: "cave-hira",
    ...
    keyEvents: [
      ...
      "Hazrat Khadijah comforted him upon his return",
    ],
    connectedJourneys: [],
    modelType: "mountain",
    annotations: [
  ...
  },
  {
    ...
    keyEvents: [
      ...
      "Hazrat Asma brought food, Hazrat Abdullah brought intelligence",
    ],
    connectedJourneys: ["hijrah"],
    modelType: "mountain",
    annotations: [
      { position: [0.8, 2.3, 1], label: "Cave Entrance", detail: "The cave is large enough for two people. A spider spun its web over the entrance and a dove nested there, concealing the Prophet ﷺ and Hazrat Abu Bakr from Quraysh trackers." },
