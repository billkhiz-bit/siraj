  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="relative h-[420px] w-full overflow-hidden rounded-xl border border-border bg-[#0a0a1a]">
        ...
        {hoveredVerse && (
          <div className="pointer-events-none absolute left-6 bottom-6 max-w-md rounded-lg border border-border bg-popover/90 px-5 py-4 shadow-xl backdrop-blur-sm">
